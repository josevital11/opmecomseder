...
<html lang="en">
    ...
    <body>
        ...
        <%
           ...
           String matricula, nomeBenef, procedimento, nomeUser, fornecedor, tuss="", comercial="", unidade="", fabricante="", precoFormatado="", descFormatado="";
           ...
           List<ModelProposta> listaItemProposta = (List<ModelProposta>)request.getAttribute("listaItemProposta");
           
           if (listaItemProposta != null){
               for (ModelProposta mlip: listaItemProposta){
                   String descStr = Double.toString(mlip.getDesconto());
                   BigDecimal desc = new BigDecimal (descStr);  
                   NumberFormat nfd = NumberFormat.getCurrencyInstance();  
                   descFormatado = nfd.format (desc);
                   
                   String precoUnitStr = Double.toString(mlip.getUnitario());
                   BigDecimal valor = new BigDecimal (precoUnitStr);  
                   NumberFormat nf = NumberFormat.getCurrencyInstance();  
                   precoFormatado = nf.format (valor);
               }
           }
       %>
                                            ...
                                            <div class="card">
                                                <div class="card-block">
                                                    ...
                                                    <form class="form-material" 
                                                        ...
                                                        <% if (listaCirurgia != null){ %>   
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="row"> 
                                                                    ...
                                                                    <% for (ModelProposta mli: listaItemProposta){ %>
                                                                       
                                                                    <div class="col-md-2">  

                                                                        <div class="form-group form-default form-static-label">
                                                                            <input type="text" name="desconto" id="desconto"
                                                                                   class="form-control" required="required" onfocus="formatarValor()
                                                                                   autocomplete="off" value="<%=descFormatado%>" /> <span
                                                                            ...
                                                                            <script>
                                                                                function formatarValor(){
                                                                                  $("#desconto").maskMoney({showSymbol: true, symbol: "R$ ", decimal: ",", thousands: "."});
                                                                                    ...
                                                                                    $("#desconto").val(formatter.format($("#desconto").val()));
                                                                    ...
                                                                    <div class="col-md-2">     
                                                                        ...
                                                                        <div class="form-group form-default form-static-label float-left">
                                                                            <input type="text" name="tuss" id="tuss"
                                                                                   ...
                                                                                   autocomplete="off" value="<%=mli.getTuss()%>" /> <span
                                                                ...
                                                                <div class="row">  
                                                                    ...
                                                                    <div class="form-group form-default form-static-label float-left">
                                                                        <input type="text" name="unidade" id="unidade"
                                                                               class="form-control" required="required"
                                                                               autocomplete="off" value="<%=mli.getUnidade()%>" /> <span
                                                                    ...
                                                                    <div class="col-md-2">     
                                                                        ...
                                                                        <div class="form-group form-default form-static-label float-left">
                                                                            <input type="text" name="preco" id="preco"
                                                                                   class="form-control" required="required" onfocus="formatarValor()"
                                                                                   autocomplete="off" value="<%=precoFormatado%>" /> <span
                                                                    ...
                                                                    <div class="col-md-2">     
                                                                        ...
                                                                        <div class="form-group form-default form-static-label float-left">
                                                                            <input type="text" name="anvisa" id="anvisa"
                                                                                   class="form-control" required="required"
                                                                                   autocomplete="off" value="<%=mli.getAnvisa()%>" /> <span
                                                                    ...
                                                                    <div class="col-md-2">   
                                                                        ...
                                                                        <div class="form-group form-default form-static-label float-left">
                                                                            <input type="text" name="idOpme" id="codOpme"
                                                                                   class="form-control" required="required"
                                                                                          value="<%=mli.getId_opme()%>" />
                                                                            <span
                                                                    ...
                                                                    <div class="col-md-1">  
                                                                        ...
                                                                        <div class="form-group form-default form-static-label form-group float-row">
                                                                            <input type="text" name="codProp" id="codProp" class="form-control"
                                                                                   readonly="readonly" value="<%=mli.getId_prop()%>" /> <span
                                                                                   class="form-bar"></span> <label class="float-label">ID PROP:</label>
                                                                        </div>
                                                            ...
                                                            <%}else {%>
                                                                ...
                                                                <div class="col-md-2">     
                                                                    <div class="form-group form-default form-static-label">
                                                                        <input type="text" name="desconto" id="desconto"
                                                                               class="form-control" required="required"  onfocus="formatarDesc()"
                                                                               autocomplete="off" value="" />  <span
                                                                               class="form-bar"></span> <label class="float-label">Desconto:</label>
                                                                        <script>
                                                                            function formatarDesc(){
                                                                              $("#desconto").maskMoney({showSymbol: true, symbol: "R$ ", decimal: ",", thousands: "."});
                                                                    ...
                                                                    <div class="col-md-2">     
                                                                     ...
                                                                     <div class="col-md-10">   
                                                                        ...
                                                                        <div class="form-group form-default form-static-label">
                                                                            <input type="text" name="comercial" id="comercial"
                                                                                   class="form-control" required="required" autocomplete="off"
                                                                                   value="" /><span class="form-bar"></span> 
                                                                                   <label class="float-label">Nome comercial:</label>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-md-2">     
                                                                     ...
                                                                     <div class="col-md-10">   
                                                                          ...
                                                                          <div class="form-group form-default form-static-label">
                                                                            <input type="text" name="comercial" id="comercial"
                                                                                   class="form-control" required="required" autocomplete="off"
                                                                                   readonly="readonly" value="" /><span class="form-bar"></span>
                                                                            <label class="float-label">Nome comercial:</label>
                                                                        </div>
                                                                ...
                                                                <div class="row">  
                                                                    ...
                                                                    <div class="col-md-2">     
                                                                        ...
                                                                        <div class="form-group form-default form-static-label float-left">
                                                                            <input type="text" name="preco" id="preco"
                                                                                   class="form-control" required="required" readonly="readonly"
                                                                                   autocomplete="off" value="" /> <span class="form-bar"></span> 
                                                        ...
                                                        <a href="<%= request.getContextPath() %>/fornecedor/relproposta.jsp"
                                                           class="btn btn btn btn-light waves-effect waves-light">Imprimir</a>
                                                        <a href="<%= request.getContextPath() %>/fornecedor/enviaProposta.jsp"  
                                                            class="btn btn-primary waves-effect waves-light">Enviar</a>
                                                           
                                                    </form>
                                                        <script>
                                                            input btn = document.querySeletor("#send");
                                                            btn.addEventListneer("click", function(e)){
                                                                e.preventDefault();
                                                                const name = document.querySelector("#codCir");
                                                                const value = name.value;
                                                                console.log(value);
                                                            };
                                                                <!--
                                                            function criarEnviar() {
                                                                //if (confirm("Deseja realmente enviar a proposta?")) {
                                                                //    document.getElementById('formUser').method = "get";
                                                                //    document.getElementById('acao').value = "enviar";
                                                                //    document.getElementById('formUser').submit();
                                                                }
                                                            }
                                                                -->
