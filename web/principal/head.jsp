<%-- 
    Document   : head
    Created on : 13/04/2022, 15:14:02
    Author     : Usuario
--%>
...
<html>
    <head>
        <title>Sistema OPME Comseder</title>
    ...
    <!--[if lt IE 10]>
      ...
      <meta name="description" content="Projet de estudos feito em JSP." />
      <meta name="author" content="Jose Vital Neto" />
      <!-- Favicon icon -->
