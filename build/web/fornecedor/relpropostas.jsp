										...
										<div class="card">
											<div class="card-block">
												...
												<form class="form-material" action="<%=request.getContextPath()%>/ServletProposta"
													...
													<input type="hidden" id="acaoRelatorioImprimirTipo" name="acao" value="imprimirRelPropostas">
													
                                                                                                       <!--
                                                                                                        <div class="form-row align-items-center">
                                                                                                            
                                                                                                            <div class="col-mb-1">
                                                                                                                <h4>Digite o código da cirurgia:</h4>
													...
													-->
														...
														<!--	<button type="button" onclick="imprimirHtml();" class="btn btn-primary">Imprimir relatório</button>
															...
															<button type="button" class="btn btn-primary">Imprimir PDF</button>  -->
                                                                                                                         ...
                                                                                                                         <input type="submit" value="Visualizar relatório" class="btn btn-primary" target="_blank">
														</div>
													</div>
													</div>
												</form>	
