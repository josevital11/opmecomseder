...
<html lang="en">
    ...
    <body>
        ...
        <%
           int codOpme, codCir, codProp=0, qtd; 
           Double desconto=0.0, precoUnit;
           String matricula, nomeBenef, procedimento, nomeUser, fornecedor, tuss, comercial, unidade;
                                                                    ...
                                                                    <div class="col-md-1">   
                                                                        ...
                                                                        <div class="form-group form-default form-static-label float-left">
                                                                            <input type="text" name="idOpme" id="idOpme"
                                                                                   class="form-control" required="required" readonly="readonly"
                                                                                          value="" />
                                                                            <span class="form-bar"></span> <label class="float-label">ID OPME:</label>
                                                                        </div>
