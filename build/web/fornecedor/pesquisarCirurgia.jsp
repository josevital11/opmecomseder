						...
						<div class="page-wrapper">
							...
							<div class="page-body">
								<div class="row">
                                                                    ...
                                                                    <h3>Pesquisa cirurgia</h3>
                                                                        <div id="posicao">                                                                    
	
                                                                            <form action="<%=request.getContextPath() %>/ServletProposta" method="get" class="row g-3 needs-validation" novalidate>
                                                                                <input type="hidden" value="<%=request.getParameter("url")%>" name='url'>
                                                                                <input type="hidden" value="buscarCirurgia-ajax" name="acao">
                                                                                    <div class="col-mb-3">
                                                                                        <h4>Digite o código da cirurgia (informado):</h4>
