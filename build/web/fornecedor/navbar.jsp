<%-- 
    Document   : navbar
    Created on : 13/04/2022, 15:19:28
    Author     : Usuario
--%>
          ...
          <nav class="navbar header-navbar pcoded-header">
              <div class="navbar-wrapper">
                  <div class="navbar-logo">
                      ...
                      <a href="index.html">
                          <img width="180px" class="img-fluid" src="<%=request.getContextPath() %>/assets/images/Comseder_logo.png" alt="Theme-Logo" />
                      </a>
                          ...
                          <li class="header-notification">
                              ...
                              <ul class="show-notification">
                                  ...
                                  <li class="waves-effect waves-light">
                                      <div class="media">
                                          <img class="d-flex align-self-center img-radius" src="<%=request.getContextPath() %>" alt="">
                                          <div class="media-body">
                                              <h5 class="notification-user"><%=session.getAttribute("usuario")%></h5>
                                              <p class="notification-msg">Você está logado(a) no Sistema.</p>
                                              <span class="notification-time">Bom proveito!</span>
                                          </div>
                                      </div>
                                  </li>
                                  <!--
